...
"""See docstring for WaveVersioner class"""
...
__all__ = ["WaveVersioner"]


class WaveVersioner(DmgMounter):
    """Returns version of Wave information from a plist"""
    description = __doc__
    ...
    def main(self):
        ...
        try:
            ...
            try:
                ...
                self.env['version'] = plist.get(version_key, "UNKNOWN_VERSION").replace("Wave v", "")
